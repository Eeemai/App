...
export default function FirstAid({ navigation }) {
  return (
    <View style={styles.container}>
      ...
      >
        In other cases, first aid consists of the care provided to someone with
        a minor injury. For example, first aid is often all that’s needed to
        treat minor burns, cuts, and insect stings.
      </Text>
